...
export default function EditRevenueModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div
        className="bg-mauve-1 border border-mauve-4 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]"
      ...
      >
        ...
        <div className="overflow-y-auto p-6 space-y-4 custom-scrollbar">
          ...
          >
            ...
            {log.editor?.name && (
              <div className="bg-mauve-3/50 px-3 py-2 rounded-lg border border-mauve-4 mt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                <span className="text-[10px] font-black uppercase text-mauve-10 tracking-widest inline-flex items-center gap-1.5">
                  <Edit size={12} /> AUDIT LOG
                </span>
                <span className="text-[11px] font-mono text-mauve-11">
